...
Дополнительно: заполнить `title_kk` по всем действующим статусам (сейчас пусто во всех 12 записях — казахская версия UI не работает). Значения предоставляет заказчик.
...
Если бизнес допускает повторные уведомления по той же записи — индекс заменить на частичный (исключить аннулированные уведомления). Требует подтверждения заказчика (OQ-08).
